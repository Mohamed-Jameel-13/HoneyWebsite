    ...
    <UIProvider>
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 md:py-16 lg:py-20">
        <div className="text-center mb-12 md:mb-16">
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-4">Contact Us</h1>
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
            Have questions about our honey? We'd love to hear from you. Send us a message and we'll respond as soon as possible.
          </p>
        </div>
